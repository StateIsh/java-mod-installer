...
//    private static final String REPLAYVC_URL      = "https://dl.ishciv.com/modpacks/replayvoicechat-1.20.1-1.3.3.jar";
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            ...
            JLabel desc = new JLabel("<html>It’s time to prepare you for the State Parkour Event! This will create a new profile in your Minecraft Launcher with all mods installed.</html>");
                ...
                SwingWorker<Void, Void> worker = new SwingWorker<>() {
                    ...
                    protected Void doInBackground() {
                        try {
                            ...
                            if (sodium.isSelected())          Installer.downloadAndCopyMod(SODIUM_URL,        "sodium.jar");
                            if (iris.isSelected())            Installer.downloadAndCopyMod(IRIS_URL,          "iris.jar");
                            if (logicalZoom.isSelected())     Installer.downloadAndCopyMod(LOGICAL_ZOOM_URL,  "logical_zoom.jar");
                            if (replayMod.isSelected())       Installer.downloadAndCopyMod(REPLAYMOD_URL,     "replaymod.jar");
//                            if (replayVoiceChat.isSelected()) Installer.downloadAndCopyMod(REPLAYVC_URL,      "replayvoicechat.jar");
